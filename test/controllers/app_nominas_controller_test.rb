...
class AppNominasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create app_nomina" do
    assert_difference("AppNomina.count") do
      post app_nominas_url, params: { app_nomina: { app_nomina: @app_nomina.app_nomina, email: @app_nomina.email } }
    end
  ...
  test "should update app_nomina" do
    patch app_nomina_url(@app_nomina), params: { app_nomina: { app_nomina: @app_nomina.app_nomina, email: @app_nomina.email } }
