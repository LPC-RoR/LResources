...
class CargosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cargo" do
    assert_difference("Cargo.count") do
      post cargos_url, params: { cargo: { area_id: @cargo.area_id, cargo: @cargo.cargo, dotacion: @cargo.dotacion } }
    end
  ...
  test "should update cargo" do
    patch cargo_url(@cargo), params: { cargo: { area_id: @cargo.area_id, cargo: @cargo.cargo, dotacion: @cargo.dotacion } }
