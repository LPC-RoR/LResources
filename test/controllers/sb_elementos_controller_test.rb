...
class SbElementosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sb_elemento" do
    assert_difference("SbElemento.count") do
      post sb_elementos_url, params: { sb_elemento: { acceso: @sb_elemento.acceso, activo: @sb_elemento.activo, controlador: @sb_elemento.controlador, despliegue: @sb_elemento.despliegue, nivel: @sb_elemento.nivel, orden: @sb_elemento.orden, sb_elemento: @sb_elemento.sb_elemento, sb_lista_id: @sb_elemento.sb_lista_id, tipo: @sb_elemento.tipo } }
    end
