...
class AppContactosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create app_contacto" do
    assert_difference("AppContacto.count") do
      post app_contactos_url, params: { app_contacto: { app_contacto: @app_contacto.app_contacto, email: @app_contacto.email, owner_class: @app_contacto.owner_class, owner_id: @app_contacto.owner_id, telefono: @app_contacto.telefono } }
    end
  ...
  test "should update app_contacto" do
    patch app_contacto_url(@app_contacto), params: { app_contacto: { app_contacto: @app_contacto.app_contacto, email: @app_contacto.email, owner_class: @app_contacto.owner_class, owner_id: @app_contacto.owner_id, telefono: @app_contacto.telefono } }
