...
class AppDirectoriosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create app_directorio" do
    assert_difference("AppDirectorio.count") do
      post app_directorios_url, params: { app_directorio: { app_directorio: @app_directorio.app_directorio, owner_class: @app_directorio.owner_class, owner_id: @app_directorio.owner_id } }
    end
  ...
  test "should update app_directorio" do
    patch app_directorio_url(@app_directorio), params: { app_directorio: { app_directorio: @app_directorio.app_directorio, owner_class: @app_directorio.owner_class, owner_id: @app_directorio.owner_id } }
