...
class AppDocumentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create app_documento" do
    assert_difference("AppDocumento.count") do
      post app_documentos_url, params: { app_documento: { app_documento: @app_documento.app_documento, owner_class: @app_documento.owner_class, owner_id: @app_documento.owner_id } }
    end
  ...
  test "should update app_documento" do
    patch app_documento_url(@app_documento), params: { app_documento: { app_documento: @app_documento.app_documento, owner_class: @app_documento.owner_class, owner_id: @app_documento.owner_id } }
