...
class AppAdministradoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create app_administrador" do
    assert_difference("AppAdministrador.count") do
      post app_administradores_url, params: { app_administrador: { app_administrador: @app_administrador.app_administrador, email: @app_administrador.email } }
    end
  ...
  test "should update app_administrador" do
    patch app_administrador_url(@app_administrador), params: { app_administrador: { app_administrador: @app_administrador.app_administrador, email: @app_administrador.email } }
