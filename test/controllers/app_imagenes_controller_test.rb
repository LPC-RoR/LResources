...
class AppImagenesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create app_imagen" do
    assert_difference("AppImagen.count") do
      post app_imagenes_url, params: { app_imagen: { app_imagen: @app_imagen.app_imagen, credito_imagen: @app_imagen.credito_imagen, imagen: @app_imagen.imagen, owner_class: @app_imagen.owner_class, owner_id: @app_imagen.owner_id } }
    end
  ...
  test "should update app_imagen" do
    patch app_imagen_url(@app_imagen), params: { app_imagen: { app_imagen: @app_imagen.app_imagen, credito_imagen: @app_imagen.credito_imagen, imagen: @app_imagen.imagen, owner_class: @app_imagen.owner_class, owner_id: @app_imagen.owner_id } }
