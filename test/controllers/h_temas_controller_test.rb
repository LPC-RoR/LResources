...
class HTemasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create h_tema" do
    assert_difference("HTema.count") do
      post h_temas_url, params: { h_tema: { detalle: @h_tema.detalle, h_tema: @h_tema.h_tema } }
    end
  ...
  test "should update h_tema" do
    patch h_tema_url(@h_tema), params: { h_tema: { detalle: @h_tema.detalle, h_tema: @h_tema.h_tema } }
