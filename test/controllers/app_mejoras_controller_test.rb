...
class AppMejorasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create app_mejora" do
    assert_difference("AppMejora.count") do
      post app_mejoras_url, params: { app_mejora: { app_mejora: @app_mejora.app_mejora, app_perfil_id: @app_mejora.app_perfil_id, estado: @app_mejora.estado, owner_class: @app_mejora.owner_class, owner_id: @app_mejora.owner_id } }
    end
  ...
  test "should update app_mejora" do
    patch app_mejora_url(@app_mejora), params: { app_mejora: { app_mejora: @app_mejora.app_mejora, app_perfil_id: @app_mejora.app_perfil_id, estado: @app_mejora.estado, owner_class: @app_mejora.owner_class, owner_id: @app_mejora.owner_id } }
