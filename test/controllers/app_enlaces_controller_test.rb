...
class AppEnlacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create app_enlace" do
    assert_difference("AppEnlace.count") do
      post app_enlaces_url, params: { app_enlace: { app_enlace: @app_enlace.app_enlace, link: @app_enlace.link, owner_class: @app_enlace.owner_class, owner_id: @app_enlace.owner_id } }
    end
  ...
  test "should update app_enlace" do
    patch app_enlace_url(@app_enlace), params: { app_enlace: { app_enlace: @app_enlace.app_enlace, link: @app_enlace.link, owner_class: @app_enlace.owner_class, owner_id: @app_enlace.owner_id } }
