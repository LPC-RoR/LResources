...
class StLogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create st_log" do
    assert_difference("StLog.count") do
      post st_logs_url, params: { st_log: { app_perfil_id: @st_log.app_perfil_id, class_name: @st_log.class_name, e_destino: @st_log.e_destino, e_origen: @st_log.e_origen, objeto_id: @st_log.objeto_id } }
    end
  ...
  test "should update st_log" do
    patch st_log_url(@st_log), params: { st_log: { app_perfil_id: @st_log.app_perfil_id, class_name: @st_log.class_name, e_destino: @st_log.e_destino, e_origen: @st_log.e_origen, objeto_id: @st_log.objeto_id } }
