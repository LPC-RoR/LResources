...
class AppArchivosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create app_archivo" do
    assert_difference("AppArchivo.count") do
      post app_archivos_url, params: { app_archivo: { app_archivo: @app_archivo.app_archivo, owner_class: @app_archivo.owner_class, owner_id: @app_archivo.owner_id } }
    end
  ...
  test "should update app_archivo" do
    patch app_archivo_url(@app_archivo), params: { app_archivo: { app_archivo: @app_archivo.app_archivo, owner_class: @app_archivo.owner_class, owner_id: @app_archivo.owner_id } }
