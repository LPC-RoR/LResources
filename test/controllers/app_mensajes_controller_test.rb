...
class AppMensajesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create app_mensaje" do
    assert_difference("AppMensaje.count") do
      post app_mensajes_url, params: { app_mensaje: { app_mensaje: @app_mensaje.app_mensaje, app_perfil_id: @app_mensaje.app_perfil_id, detalle: @app_mensaje.detalle, email: @app_mensaje.email, estado: @app_mensaje.estado, fecha_envio: @app_mensaje.fecha_envio, tipo: @app_mensaje.tipo } }
    end
  ...
  test "should update app_mensaje" do
    patch app_mensaje_url(@app_mensaje), params: { app_mensaje: { app_mensaje: @app_mensaje.app_mensaje, app_perfil_id: @app_mensaje.app_perfil_id, detalle: @app_mensaje.detalle, email: @app_mensaje.email, estado: @app_mensaje.estado, fecha_envio: @app_mensaje.fecha_envio, tipo: @app_mensaje.tipo } }
