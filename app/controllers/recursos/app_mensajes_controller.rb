class Recursos::AppMensajesController < ApplicationController
  ...
  def respuesta
    ...
    @objeto = AppMensaje.create(estado: estado, fecha_envio: DateTime.current, app_perfil_id: perfil_id, tipo: tipo, app_mensaje: mensaje, detalle: detalle)
  ...
  private
    ...
    def app_mensaje_params
      params.require(:app_mensaje).permit(:app_mensaje, :tipo, :estado, :email, :fecha_envio, :detalle, :app_perfil_id)
    end
end
