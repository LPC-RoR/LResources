class ControlDocumentosController < ApplicationController
  ...
  def new
    @objeto = ControlDocumento.new(ownr_class: params[:class_name], ownr_id: params[:objeto_id])
  end
  ...
  private
    ...
    def control_documento_params
      params.require(:control_documento).permit(:control_documento, :existencia, :vencimiento, :ownr_class, :ownr_id)
    end
end
