class Autenticacion::AppEmpresasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @objeto.save
        set_redireccion
        format.html { redirect_to @redireccion, notice: "Empresa exitósamente creada." }
  ...
  def update
    respond_to do |format|
      if @objeto.update(app_empresa_params)
        set_redireccion
        format.html { redirect_to @redireccion, notice: "Empresa exitósamente actualizada." }
  ...
  def destroy
    ...
    @objeto.destroy
    respond_to do |format|
      format.html { redirect_to @redireccion, notice: "Empresa exitósmente eliminada." }
